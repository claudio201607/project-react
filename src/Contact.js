  ...
  sendMessage(e) {
    ...
    if (params.name && params.email && params.phone && params.phone && params.message) {
      ...
      firebaseConf.database().ref('form').push(params).then(() => {
        ...
        this.showAlert('success', 'Su mensaje fue enviado exitosamente');
      }).catch(() => {
      ...
      this.showAlert('warning', 'Porfavor llene el formulario');
    };
  }
              ...
              <form onSubmit={this.sendMessage.bind(this)} ref='contactForm' >
                ...
                <div className='form-group'>
                  ...
                  <input type='email' className='form-control' id='email'
                    placeholder='Correo' ref={email => this.inputEmail = email}
                  />
                </div>
                <div className='form-group'>
                  <label htmlFor='country'>Pais</label>
                  <select className='form-control' id='country' ref={country => this.inputCountry = country}>
